...
const ja: Record<string, string> = {
  ...
  changelog_v604: '・途中開始スコアをさらに実態に近い値に修正\n・週間ランキングを月曜0時始まりに変更\n・古いランキングデータの月次自動クリーンアップを追加',
...
const en: Record<string, string> = {
  ...
  changelog_v604: '・Further adjusted midway start scores\n・Weekly ranking now starts on Monday\n・Added monthly auto-cleanup of old ranking data',
